	...
	*/
	...
	Tetris.prototype = {
	    ...
	    _keydownHandler: function(e) {
	        ...
	        switch (e.keyCode) {
	            case 37:
	                { this.shape.goLeft(matrix);this._draw(); }
	                break;

	            case 39:
	                { this.shape.goRight(matrix);this._draw(); }
	                break;

	            case 38:
	                { this.shape.rotate(matrix);this._draw(); }
	                break;

	            case 40:
	                { this.shape.goDown(matrix);this._draw(); }
	                break;

	            case 32:
	                { this.shape.goBottom(matrix);this._update(); }
	                break;
	        }
	    },
	    // Restart game
	...
	*/
	var tetrisCanvas = {
	    ...
	    init: function(scene, preview) {
	        ...
	        this.gridSize = consts.BLOCK_SIZE;
